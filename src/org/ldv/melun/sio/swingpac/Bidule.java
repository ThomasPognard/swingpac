...
public class Bidule extends JPanel {
	...
	private void testWiner() {
		...
		if (aloneInTheWorld()) {
			timer.stop();
			JOptionPane.showMessageDialog(getParent(), "GAGNÉ : " + name + " Toucher : " + toucher);
	...
	public void tuEstouchePar(Bidule biduleImpacteur) {
		...
		if (getWidth() < NB_MINMAL_PIXELS_VIE
			...
			// sucide...
			this.stop();
			System.out.println("Je meurs :'( R.I.P.  " + this.name + "Tu as touché " + this.toucher + " fois");
			getParent().remove(this);
		}
	...
	public String toString() {
		return "Bidule [timer=" + timer + ", incY=" + incY + ", incX=" + incX
				+ ", name=" + name + ", NB_MINMAL_PIXELS_VIE="
				+ NB_MINMAL_PIXELS_VIE + "]";
	}
